                        ...
                        {showStudentForm && (
                            <div className="p-6 border-b border-slate-100 bg-[#0284c7]/5">
                                <form onSubmit={handleStudentSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div className="space-y-1.5"><label className="text-xs font-bold text-slate-700 uppercase">Full Name</label><input required className="saas-input py-2.5" value={studentFormData.name} onChange={e => setStudentFormData({ ...studentFormData, name: e.target.value })} placeholder="John Doe" /></div>
