            ...
            <div class="grid grid-cols-2 lg:grid-cols-5 md:grid-cols-3 gap-8 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-slate-500">
                        ...
                        <li><span class="block text-slate-900 font-medium">Email:</span> <a href="mailto:gnandevbonthu12@gmail.com" class="hover:text-brand-600 transition-colors break-all">gnandevbonthu12@gmail.com</a></li>
